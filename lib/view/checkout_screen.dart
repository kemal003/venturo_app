...
import 'package:venturo_app/widgets/item_card.dart';
import 'package:venturo_app/widgets/voucher_sheet.dart';
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              const SizedBox(width: 10),
                              ElevatedButton(
                                onPressed: cartViewModel.itemCount != 0
                                    ? () {
                                        cartViewModel.sendOrder(
                                          voucherViewModel.savedVoucher?.id,
                                          voucherViewModel.savedVoucher?.nominal ?? 0,
                                          calculatePrice(),
                                        );
